...
mysql innodb引擎默认是RR(可重复读)的隔离级别,在mysql中通过MVCC快照读和next-key(当前读)两种模式解决幻读问题.
...
![img](https://pic3.zhimg.com/80/v2-36146d7d99febb671067381085eabff2_1440w.jpg)
...
![img](https://pic2.zhimg.com/80/v2-a3dd0f932beec215de79648eb2559d71_1440w.jpg)
